...
4. Deploy. The app works with zero env vars set (demo mode) or fully live if Supabase/AI vars are set.

No special build configuration is required — this is a standard Next.js 14 App Router project.
